...
import com.customer.zokudo.exceptions.ForbiddenException;
import com.customer.zokudo.exceptions.UnAuthorizedException;
import com.customer.zokudo.util.CommonUtil;
import com.customer.zokudo.util.UrlMetaData;
...
public class AuthInterceptor extends HandlerInterceptorAdapter {
    ...
    public boolean preHandle(final HttpServletRequest request, final HttpServletResponse response, final Object handler) throws Exception {
        try {
            if (checkWebhookURI(request)) {
                log.info("Webhook Notify URL Validated");
                return true;
            }
    ...
    private boolean checkWebhookURI(HttpServletRequest request) {
